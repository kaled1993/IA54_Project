...
public abstract class Tuple2f implements java.io.Serializable, Cloneable {
    ...
    /**
     * Constructs and initializes a Tuple3f from the array of length 2.
   ...
   /**
    ...
    /**
     * Sets the value of this tuple to the xy coordinates specified in
    ...
    public void setXY(Vector2f vect){
    	x = vect.x;
    	y = vect.y;
   ...
   /**
     ...
     * @param t  the array of length 2 into which the values are copied
     */
